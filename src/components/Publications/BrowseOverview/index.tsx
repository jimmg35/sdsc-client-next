          ...
          <ul className="mt-8">
            {latestPublications.map((publication) => (
              <li key={publication.id} className={`border-t ${RULE} py-7`}>
                <p className="text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-primary-600">
                  {t('published', {
                ...
                {publication.doi ? (
                  <a
                    ...
                    target="_blank"
                    rel="noreferrer"
                    className="group/link mt-4 inline-flex max-w-4xl items-start gap-2 text-xl font-medium leading-snug tracking-[-0.015em] text-ink-900 transition-colors duration-300 hover:text-primary-600 md:text-2xl md:leading-[1.3]"
                  >
