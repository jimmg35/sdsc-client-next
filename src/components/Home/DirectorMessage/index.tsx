...
const DirectorMessage = async () => {
  ...
  return (
    <section className="surface-fade relative overflow-hidden rounded-none px-6 py-20 md:px-16 md:py-28">
      ...
      />
      <div className="section-wash pointer-events-none absolute inset-0" />
      ...
      <div className="relative mx-auto w-full max-w-5xl">
        ...
        <h2 className="flex items-center justify-center gap-5">
          <span
            aria-hidden
            className="hidden h-px flex-1 bg-gradient-to-r from-transparent to-accent-600/45 md:block"
          />
          <span className="text-center text-[0.7rem] font-semibold uppercase tracking-[0.34em] text-accent-700 md:text-xs md:tracking-[0.45em]">
            {t('eyebrow')}
          </span>
          <span
            aria-hidden
            className="hidden h-px flex-1 bg-gradient-to-l from-transparent to-accent-600/45 md:block"
          />
        </h2>
        ...
        <div className="mt-14 flex flex-col items-center gap-12 md:flex-row md:items-start md:gap-16">
          <figure className="flex w-full max-w-[16.5rem] shrink-0 flex-col items-center">
            ...
            <span aria-hidden className="mt-6 h-px w-14 bg-accent-600/50" />
            <figcaption className="mt-4 text-center text-[0.65rem] font-semibold uppercase tracking-[0.3em] text-accent-700">
              {t('role')}
            </figcaption>
          </figure>
          ...
          <div className="relative flex-1">
            <span
              aria-hidden
              className="pointer-events-none absolute -left-9 -top-16 hidden select-none font-serif text-[11rem] leading-none text-accent-600/20 md:block"
            >
              &ldquo;
            </span>
            ...
            <div className="mt-10 flex items-center justify-end border-t border-accent-600/25 pt-7">
              <Image
