    ...
    <main className="page-shell flex min-h-screen items-center justify-center px-6 py-16">
      <section className="glass-card relative w-full max-w-5xl overflow-hidden p-10 md:p-14">
        <div className="absolute inset-0 -z-10 opacity-80">
          <div className="absolute -left-24 -top-16 h-52 w-52 rounded-full bg-primary-200/70 blur-3xl" />
          <div className="absolute -bottom-20 right-0 h-60 w-60 rounded-full bg-accent-200/70 blur-3xl" />
        </div>

        <div className="grid gap-10 lg:grid-cols-[1.2fr_0.8fr] lg:items-start">
          <div>
            <div className="chip-accent mb-6">{t('notice')}</div>
            ...
            <div className="mt-10 flex flex-col gap-4 sm:flex-row sm:items-center">
              <a
                className="calcite-focus inline-flex items-center justify-center gap-2 rounded-full bg-primary-500 px-8 py-3 text-sm font-semibold uppercase tracking-[0.18em] text-white shadow-lg transition hover:-translate-y-0.5 hover:bg-primary-600"
          ...
          <div className="surface-fade p-6 md:p-8">
            ...
            <div className="space-y-4 text-sm text-ink-700">
              <div className="rounded-2xl border border-primary-100/80 bg-surface/80 p-4">
