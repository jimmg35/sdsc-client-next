  ...
  return (
    <section className="page-shell">
      <div className="mx-auto max-w-5xl px-6 pb-28 pt-36 md:pt-40">
        ...
        >
          <div>
            <dt className="text-[0.68rem] font-semibold uppercase tracking-[0.26em] text-silk-700">
              {t('emailLabel')}
            </dt>
            <dd className="mt-4">
              <a
                href={`mailto:${CONTACT_EMAIL}`}
                className="group inline-flex items-center gap-3 text-xl font-medium tracking-[-0.01em] text-ink-900 transition-colors duration-300 hover:text-rose-600 md:text-2xl"
              >
                {CONTACT_EMAIL}
                <ArrowUpRight
                  size={20}
                  aria-hidden
                  className="shrink-0 text-rose-600 transition-transform duration-300 group-hover:-translate-y-0.5 group-hover:translate-x-0.5"
                />
              </a>
            </dd>
          </div>
        ...
        <section className={`mt-20 border-t ${RULE} pt-10`}>
          ...
          <a
            href={`mailto:${CONTACT_EMAIL}`}
            className="group mt-8 inline-flex items-center gap-2 rounded-full border border-rose-400/70 bg-rose-500/90 px-6 py-3 text-[0.68rem] font-semibold uppercase tracking-[0.24em] text-white transition duration-300 hover:bg-rose-600"
          >
            {t('emailLabel')}
            <ArrowUpRight
              size={16}
