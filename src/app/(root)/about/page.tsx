      ...
      <div className="mx-auto max-w-6xl px-6 pb-28 pt-36 text-gold-100 md:pt-40">
        ...
        <section className="mt-16 grid gap-6 md:grid-cols-3">
          {pillars.map(({ title, description, icon: Icon }) => (
            <article
              key={title}
              className="glass-card flex flex-col gap-4 px-6 py-8 text-gold-100"
            >
              <div className="flex items-center gap-3 text-gold-200">
                ...
                <h2 className="text-lg font-semibold text-gold-50">{title}</h2>
              </div>
        ...
        <section className="mt-20 grid gap-8 md:grid-cols-[1.3fr_1fr] text-gold-100">
          <article className="surface-fade px-8 py-10">
            <h2 className="panel-title text-gold-300">Our Mission</h2>
            <p className="mt-6 text-sm leading-7 text-gold-200/80 md:text-base">
            ...
            <p className="mt-4 text-sm leading-7 text-gold-200/80 md:text-base">
          ...
          <article className="glass-card px-6 py-8 text-gold-100">
            <h3 className="panel-title text-gold-300">At a Glance</h3>
          ...
          {initiatives.map(({ title, description, icon: Icon }) => (
            ...
            >
              <div className="flex items-center gap-3 text-gold-200">
                ...
                <h3 className="text-lg font-semibold text-gold-50">{title}</h3>
              </div>
              <p className="text-sm leading-6 text-gold-200/80">
                {description}
              </p>
