...
- **Explainable GeoAI:** developing transparent machine learning models that show *why* spatial predictions are made, improving trust and adoption.
...
*Story adapted from reporting by Rebecca Sage and Rachel Lechwar for FSU News.*
